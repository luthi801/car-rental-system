...
@endif
                 ...
                 <!-- TABLE-->
                 <h1 class="text-center text-white">DriveXpress Available Cars</h1>
            ...
            <td><a onclick="return confirm('Confirm Edit?')" class="btn btn-success" href="{{url('v_edit_product',$product_data->id)}}">Edit</a></td>
            <td><a onclick="return confirm('Confirm Delete?')" class="btn btn-danger" href="{{url('v_delete_product',$product_data->id)}}">Delete</a></td>
        </tr>
