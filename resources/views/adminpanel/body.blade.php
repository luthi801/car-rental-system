                    ...
                    <div class="row">
                      <div class="col-9">
                        <div class="d-flex align-items-center align-self-start">
                          <h3 class="mb-0"> {{ $proCount }} cars</h3>
                        </div>
                      </div>
                      <div class="col-3">
              ...
              <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <h6 class="text-muted font-weight-normal">Total rent revenue</h6>
                  </div>
                </div>
              </div>
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      <div class="col-9">
                        <div class="d-flex align-items-center align-self-start">
                          <h3 class="mb-0">{{$userCount}} Customers</h3>
                  ...
                  <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col-8 col-sm-12 col-xl-8 my-auto">
                        ...
                        <h6 class="text-muted font-weight-normal">Original DRIVEXPRESS earning</h6>
                      </div>
