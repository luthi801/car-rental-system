    ...
    <div class="container-scroller">
        ...
        <div class="main-panel">
            ...
            <div class="content-wrapper">
                ...
                <!-- TABLE-->
                <h1 class="text-center text-white">DriveXpress Vendors</h1>
                    ...
                    <table class="table table-bordered mt-5">
                        ...
                        <tbody style="background-color: #eaf4f4; color: #333;">
                            ...
                            <tr class='text-center'>
                                ...
                                <td><a onclick="return confirm('Confirm approve?')" class="btn btn-success"
                                        href="{{url('approve_vendor',$vendor_data->id)}}">Approve</a></td>
                                <td><a onclick="return confirm('Confirm Delete?')" class="btn btn-danger"
                                        href="{{url('delete_vendor',$vendor_data->id)}}">Delete</a></td>
                            </tr>
